    ...
    void main() {
        ...
        //f_color = vec4(texture(tex, sample_pos).r, texture(tex, uvs).gb, 1.0);
        //
        //sample_pos = vec2(uvs.x, uvs.y + cos(time) * 0.002);
        //f_color += vec4(texture(tex, uvs).rg, texture(tex, sample_pos).b, 0.0); 
        ...
        //f_color += shadow_color;
        //f_color += current_color;
        
        vec2 uv = (uvs * 2.0 - vec2(800.0, 600.0)) / 600.0;
        vec2 mo = (vec2(400.0, 300.0) * 2.0 - vec2(800.0, 600.0)) / 600.0;
