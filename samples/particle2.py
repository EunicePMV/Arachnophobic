...
class ParticleStar:
	def __init__(self):
		self.particles = []
		self.surface = pygame.image.load('samples/assets/imgs/star.png').convert_alpha()
...
nyan_surface = pygame.image.load('samples/assets/imgs/nyan_cat.png').convert_alpha()
